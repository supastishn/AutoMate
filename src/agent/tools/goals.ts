...
const goalsTool: Tool = {
  name: 'goals',
  description: [
    'Persistent goal queue for task tracking and autonomous operation.',
    'Actions: list, add, get, update, start, complete, fail, pause, resume, delete, next, subtask, stats, settings.',
    'Advanced: extract (goals from text), approve, decompose (into sub-goals), add_recurring, retry.',
    'Supports priorities (critical/high/medium/low), dependencies, subtask checklists, and recurring goals.',
  ].join('\n'),
  parameters: {
    type: 'object',
    properties: {
